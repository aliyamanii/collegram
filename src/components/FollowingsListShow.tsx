...
import { useBlackListQuery, useFollowingsListQuery } from "../api/user";
import UserListItemBagde from "./UserListItemBagde";
import SpinnerIcon from "../assets/photos/spinner.svg";

function FollowingsListShow() {
  const { data, isLoading, isError, fetchNextPage } = useFollowingsListQuery();
  if (isLoading)
    return (
...
export default FollowingsListShow;
