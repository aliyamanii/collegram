...
const PostCard: React.FC<PostCardProps> = ({ post }) => {
  ...
  return (
    <div className="w-[360px] mx-auto my-4 hover:scale-105 transition-all duration-300 ">
      <div className="bg-[#F9F9F9] rounded-b-2xl rounded-t-3xl overflow-hidden shadow-lg">
        ...
        <div className="w-full p-4 flex flex-col justify-end items-center">
          <div className="w-full relative flex flex-row-reverse items-center justify-start gap-3 text-gray-600">
